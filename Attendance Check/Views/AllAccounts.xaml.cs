...
namespace AttendanceCheck.Views
{
    ...
    /// </summary>
    public sealed partial class AllAccounts : Page
    {
        ...
        private void MainLongListSelector_ItemClick(object sender, ItemClickEventArgs e)
        {
            //try
            //{
            gloablvalue.PageType = "1";
            gloablvalue.Acc_id = ((Accounts)e.ClickedItem).Id.ToString();
            gloablvalue.Acc_username = ((Accounts)e.ClickedItem).username;
            gloablvalue.Acc_fname = ((Accounts)e.ClickedItem).fname;
            gloablvalue.Acc_lname = ((Accounts)e.ClickedItem).lname;
            gloablvalue.Acc_type = ((Accounts)e.ClickedItem).type;
            gloablvalue.Acc_password = ((Accounts)e.ClickedItem).password;
